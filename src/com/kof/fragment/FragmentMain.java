...
public class FragmentMain extends Fragment{
	...
	private void initViewPager(View view){
		...
		FragmentViewPageAdapter fragmentViewPageAdapter= new FragmentViewPageAdapter(getChildFragmentManager(), GlobalData.getFragments());
		viewPager.setAdapter(fragmentViewPageAdapter);
	}
	
	private void initView(View view){
		mTabHost = (FragmentTabHost) view.findViewById(android.R.id.tabhost);
		horizontalScrollView = (HorizontalScrollView)mTabHost.findViewById(R.id.tab_scroll);
		...
		mTabHost.setOnTabChangedListener(new OnTabChangeListener() {
			...
			public void onTabChanged(String arg0) {
				...
				if(currentTab >= GlobalData.DISPLAY_NUM/2){
					horizontalScrollView.smoothScrollTo((int)horizontalScrollView.getX()+movingCount(currentTab),
	...
	private int movingCount(int offset){
		return screenWidth/GlobalData.DISPLAY_NUM*(offset-GlobalData.DISPLAY_NUM/2);
	}
	...
	public View onCreateView(LayoutInflater inflater,
		...
		for(int i = 0;i < tab_count;i++){
			tabWidget.getChildTabViewAt(i).setMinimumWidth(screenWidth/GlobalData.DISPLAY_NUM);
		}
	...
	public void onResume() {
		// TODO Auto-generated method stub
		super.onResume();
		horizontalScrollView.smoothScrollTo((int)horizontalScrollView.getX()+movingCount(mTabHost.getCurrentTab()),
				(int)horizontalScrollView.getY());
	}
